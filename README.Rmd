...
```{r static, fig.width = 9, fig.height = 8, message = FALSE, warning = FALSE}
polar_data %>%
  openair::cutData("daylight") %>%
  polarMapStatic(
    pollutant = "no2",
...
Please note that the `{openairmaps}` project is released with a [Contributor Code of Conduct](https://davidcarslaw.github.io/openairmaps/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
